...
import {StyleSheet, View, TouchableOpacity, Image,FlatList,Text,Dimensions,CameraRoll,ActivityIndicator,Platform,Keyboard} from 'react-native';
          ...
          <TouchableOpacity style={styles.finish}
            onPress={()=>{
              ...
              if(from==='mission'){
                ...
                this.props.navigation.navigate('Post',{result:this.state.result})
              }
            }}
          >
