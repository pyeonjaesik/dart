...
class MscpScreen extends Component{
  constructor(props){
    super(props);
    this.state={
    ...
    console.log(`mscp nav`);
    console.log(`_id :${this.props.navigation.getParam('_id')}
    ms_id: ${this.props.navigation.getParam('ms_id')} 
    post_id: ${this.props.navigation.getParam('post_id')}
    id2: ${this.props.navigation.getParam('id2')}
    `)
  }
      ...
      if(this.passCode.length==6){
        ...
        .then(async (responseJson) => {
          if(responseJson.status===100){
            console.log('Mscp pw success');
            this.props.navigation.goBack();
            Toast.show('다트가 정상적으로 전달되었습니다.');
...
export default connect(null,mapDispatchToProps)(MscpScreen);