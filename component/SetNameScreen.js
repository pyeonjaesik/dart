...
import {StyleSheet, View, TouchableOpacity, Image, Text, TextInput,BackHandler,KeyboardAvoidingView,Platform} from 'react-native';
...
class SetNameScreen extends Component{
  ...
  async _finishName(){
    if(this.props.navigation.getParam('from','')!=='Setting'){
      await this.props.navigation.navigate('SetPass',{
...
export default connect(null,mapDispatchToProps)(SetNameScreen);